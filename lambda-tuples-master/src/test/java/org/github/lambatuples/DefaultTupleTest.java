...
public class DefaultTupleTest {
    ...
    public void testValWithType() throws Exception {
        Tuple tuple = new DefaultTuple(tCons("one", "hello"), tCons("two", "world"));
    ...
    public void testAsInt() throws Exception {
        Tuple tuple = new DefaultTuple(tCons("one", "1"));
    ...
    public void testAsFloat() throws Exception {
        Tuple tuple = new DefaultTuple(tCons("one", "1.0"));
    ...
    public void testAsChar() throws Exception {
        Tuple tuple = new DefaultTuple(tCons("one", "a"));
    ...
    public void testAsBoolean() throws Exception {
        Tuple tuple = new DefaultTuple(tCons("one", "yes"),tCons("two", 'y'), tCons("three",true));
    ...
    public void testSubSet() throws Exception {
        Tuple tuple = new DefaultTuple(tCons("one", "yes"),tCons("two", 'y'), tCons("three",true), tCons("four","test"));
    ...
    public void testMerge() throws Exception {
        Tuple first = new DefaultTuple(tCons("one", "yes"),tCons("two", 'y'), tCons("three",true), tCons("four","test"));
        Tuple second = new DefaultTuple(tCons("three", "yes"),tCons("four", 'y'), tCons("five",true), tCons("six","test"));
