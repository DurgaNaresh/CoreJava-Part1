...
public class Exercise13 {
  public static void main(String[] args) {
    ...
    List<Student> students =
        List.of(new Student("Panku", "Yadav", 21, "male", "Accounts", 2021, "Delhi", 4),
    ...
    Map<String, Long> studentsForEachDept = students.stream().map(Student::getDepartmentName)
        .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));

    studentsForEachDept.forEach((department, count) -> System.out
        .println("Department: " + department + ", Count: " + count));
  }
}
